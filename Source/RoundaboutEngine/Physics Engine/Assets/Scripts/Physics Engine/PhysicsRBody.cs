...
public class PhysicsRBody : MonoBehaviour
{
    ...
    /*
     * Sets the boundary boxs from bottom left corner to top right corner
     */
    void SetAABB()
    {
    ...
    public void Integrate(float dT){
        ...
        //To see if the object can be affected by gravity and its in the air, add gravity as a force
